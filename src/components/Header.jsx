...
const Header =()=>{
    ...
    <Link to={'/'} className="text-red flex items-center gap-1">
    ...
    <Link to={user?'/account':'/login'} className="text-red flex items-center gap-2 border border-gray-300 rounded-full py-2 px-4">
